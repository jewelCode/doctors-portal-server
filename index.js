...
const uri = `mongodb+srv://${process.env.DB_USERNAME}:${process.env.DB_PASSWORD}@cluster0.bxf8a.mongodb.net/myFirstDatabase?retryWrites=true&w=majority`;
  ...
  try {
    ...
    */
    ...
    app.get('/available', async (req, res) => {
      ...
      // step : find bookings for that service
